...
const ProductDetails = ({ data }) => {
  ...
  const addToCartHandler = async (id, selectedSize, count) => {
    const isItemExists = cart && cart.find(
      (i) => i._id === data._id && i.size === selectedSize && i.isSelected);
    if (isItemExists) {
      ...
      if (selectedSize === '') {
        ...
        if (!selectedProduct || selectedProduct.quantity < 1) {
          ...
          const updatedStock = data.stock.map((item) => ({
            ...item,
            isSelected: item.size === selectedSize ? true : item.isSelected,
            quantity: item.size === selectedSize ? item.quantity - count : item.quantity
          }));
              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    // let j1=data.stock.find((val)=>{
                    
                    //    return val.size==selectedSize ;
                       
                    // })
                    //  console.log("object65",j1)
                    addToCartHandler( data._id, selectedSize, count);
                  }}
                >
...
//                        return val.size==selectedSize;
//                     })
//                      console.log("object",j1)
//                     addToCartHandler( j1._id, selectedSize, count);
//                   }}
//                 >
//                   <span className="text-white flex items-center">
//                     Add to cart <AiOutlineShoppingCart className="ml-1" />
